...
import reservationLeftImg from '../assets/svgs/reservation/rrs.svg'
...
const Reservations = () => {
    ...
    const addActiveClass = (e)=> {
        ...
        if(kliklenenYer.classList.contains('button')){
            kliklenenYer.classList.toggle('active')
        }
    }
  ...
  return (
    <div className='row reservation'>
        <div className="col-12 col-md-6">
            <img src={reservationLeftImg} alt="" width={100} />
        </div>

        <div className="col-12 col-md-6">
            <span className='ms-5'>What we do?</span>
            <h1>Reservations Management</h1>
            <p>Fusce placerat pretium mauris, vel sollicitudin elit lacinia vitae. Quisque sit amet nisi erat.</p>

            <div className="list-section">
                <div className="list">
                    <button className='button' ref={buttonRef} onClick={addActiveClass}><svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<small>Sed eleifend est ac mi imperdiet pellentesque.</small>
                </div>
